...
public class Common {
	 ...
	 * The average webpage load time is 6 seconds 
	...
	/**
	  * Wait for the element to be present in the DOM, displayed and clickable on the page. 
	  * And returns the first WebElement using the given method.
	  * 
	  * @param WebDriver	The driver object to be used 
	  * @param By	selector to find the element
	...
	/**
	  ...
	  */
	public static List<WebElement> waitForListElementsPresent(WebDriver driver, final List<WebElement> webelements, int timeOutInSeconds) {
	...
	/**
	  ...
	  * 
	  * Some sites have tested have required a page refresh to add additional elements to the DOM.  
