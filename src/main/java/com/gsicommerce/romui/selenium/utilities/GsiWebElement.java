...
public interface GsiWebElement extends WebElement {
	...
	/**
	 * Enter value on the webelement. This method should be used only for textboxes.
	 * 
	 * @param value
	 */
	...
	/**
	 * Select the displayed text from the list. This method should be used only for
	 * listboxes.
	 * 
	 * @param value
	 */
	...
	/**
	 * This method will return All selected options belonging on the select object
	 * 
	 * @return
	 */
	...
	/**
	 * This method will un-select a radio button (should also work for checkboxes)
	 */
	public void setUnselected();

	/**
	 * This method will set or un-set a radio button based on the value passed in
	 * (should also work for checkboxes
	 * 
	 * @param setSelected
	 * @return
	 */
