...
public class InventoryOrganizationPage {
	...
	public void clickViewInventoryOrgs() throws Exception {
		...
		rowNoInvOrg = CommonElementsPage.getRowNo(inventoryOrganizationData.getInventoryOrgID(), 1);
	...
	public void EditInventoryOrgs() throws Exception {
		...
		int rowNoGroupid = CommonElementsPage.getRowNo(inventoryOrganizationData.getGroupID(), 1);
		System.out.println("Selected row for GroupID selection is: "
				+ CommonElementsPage.getRowNo(inventoryOrganizationData.getGroupID(), 1));
		CommonElementsPage.clickSelectLink(rowNoGroupid, 3, 1, 1);
		shippingCalendarIDLookup.click();
		int rowNoCalid = CommonElementsPage.getRowNo(inventoryOrganizationData.getCalendarID(), 1);
		System.out.println("Selected row for CalendarID selection is: "
				+ CommonElementsPage.getRowNo(inventoryOrganizationData.getCalendarID(), 1));
