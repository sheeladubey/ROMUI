...
public class OrdersPage {
	...
	public void searchOrderByOrderNum(String OrderID) throws JsonParseException, JsonMappingException, IOException, Exception {
		...
		Assert.assertEquals(Webtable.getTableCellText(rowNo, 1), webOrderNumber,"Searched order doesn't display on UI");
	 ...
	 * 
	 */
	public void searchOrderByFulfillOrderNum(String FulfilmentOrderID) throws JsonParseException, JsonMappingException, IOException, Exception {
		ordersdata = OrdersData.get(env.getFileLocation());
		// select search order type
	...
	public void searchOrderByCustomerName(String Firstname, String Lastname)
		...
		if (Webtable.getRowText(rowNo).contains(webOrderNumber) && Webtable.getTableCellText(rowNo, 2).contains(customerName)) { 
		...
		Assert.assertEquals(Webtable.getTableCellText(rowNo, 2), customerName,"Searched Customer Name doesn't display on UI");		

	}

	public void searchOrderByEmail(String Email) throws JsonParseException, JsonMappingException, IOException,Exception {
		ordersdata = OrdersData.get(env.getFileLocation());
		// select search order type
		...
		if (Webtable.getRowText(rowNo).contains(webOrderNumber) && Webtable.getTableCellText(rowNo, 3).contains(emailID)) { 	
		...
		Assert.assertEquals(Webtable.getTableCellText(rowNo, 3), emailID,
				"Searched Email id doesn't display on UI");
