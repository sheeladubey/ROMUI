...
public class SafetyStockConfigsTests extends ROMUIBasePage {
	...
	@Test(enabled = false, priority = 1, description = "to Verify Safety stock is searched through Node Item in Manage Safety Stock Configuration page")
	...
	@Test(enabled = true, priority = 9, description = "to Verify add Safety stock through Node Item & Fulfillment type & supply type in Manage Safety Stock Configuration page")
