...
public class InventoryOrganizationTests extends ROMUIBasePage {
	...
	public void testViewInventoryOrgsRecord() throws Exception {
		...
		logger.info("Validate Inventory Orgs ID on View Inventory Organization Page is "+inventoryOrganizationData.getInventoryOrgID());
		...
		logger.info("Validate Inventory Organization Name on View Inventory Organization Page is"+inventoryOrganizationData.getInventoryOrgName());
		...
		logger.info("Validate Default Node Group ID on View Inventory Organization Page is: "+inventoryOrganizationData.getGroupID());
		Assert.assertTrue(
				romuipages.inventoryOrganizationPage().verifyViewInventoryOrgs(2,
						inventoryOrganizationData.getGroupID()),
				"No Data found for Default Node Group ID");
		logger.info("Validate Default Shipping Calendar ID on View Inventory Organization Page is: "+inventoryOrganizationData.getCalendarID());
		Assert.assertTrue(
				romuipages.inventoryOrganizationPage().verifyViewInventoryOrgs(3,
						inventoryOrganizationData.getCalendarID()),
				"No Data found for Default Shipping Calendar ID");
		logger.info("Validate Default ATP Rule on View Inventory Organization Page is: "+inventoryOrganizationData.getDefaultATP());
		...
		logger.info("Validate Node Rejected Supply Action on View Inventory Organization Page is:"+inventoryOrganizationData.getNodeRejected());
