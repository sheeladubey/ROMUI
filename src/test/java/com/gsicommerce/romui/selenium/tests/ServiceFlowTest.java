...
public class ServiceFlowTest extends ROMUIBasePage {
	...
	public void testViewServiceFlow() throws JsonParseException, JsonMappingException, IOException, InterruptedException {
	...
	public void testEditServiceFlow() throws JsonParseException, JsonMappingException, IOException, InterruptedException {
		...
		Assert.assertEquals(romuipages.serviceFlowPage().txtSuccessMsg.getText(),RomuiEnumValues.SERVICEFLOW_EDIT.getMessage(), "Service Flow hasn't been updated");
	...
	public void testCopyServiceFlow() throws JsonParseException, JsonMappingException, IOException {
		...
		Assert.assertEquals(romuipages.serviceFlowPage().txtSuccessMsg.getText(),RomuiEnumValues.SERVICEFLOW_SAVE.getMessage(),
	...
	public void testEditServiceFlowProcesses() throws JsonParseException, JsonMappingException, IOException {
		...
		Assert.assertEquals(romuipages.serviceFlowPage().txtSuccessMsg.getText(),RomuiEnumValues.SERVICEFLOW_EDIT.getMessage(),
