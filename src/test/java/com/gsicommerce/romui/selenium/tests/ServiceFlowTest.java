...
public class ServiceFlowTest extends ROMUIBasePage {
	  ...
	  public void testAddServiceFlow()throws JsonParseException, JsonMappingException,
	  ...
	  romuipages.serviceFlowPage().addSvcFlw(); logger.
	  ...
	  "Service Flow is not Saved successfully");
	  ...
	  public void testViewServiceFlow() throws JsonParseException, JsonMappingException,
	  IOException, InterruptedException {
	  ...
	  @Test(enabled = true, priority=5,description = "Edit Service Flow") public
	  ...
	  romuipages.orderMgmPage().clickOnServiceFlows();
	  logger.info("Navigated to Service Flow page");
	  romuipages.serviceFlowPage().editSvcFlw(); logger.
	  ...
	  "Service Flow hasn't been updated");
	  ...
	  romuipages.orderMgmPage().clickOnServiceFlows();
	  logger.info("Navigated to Service Flow page");
	  romuipages.serviceFlowPage().copySvcFlw(); logger.
	  ...
	  public void testEditServiceFlowProcesses() throws JsonParseException,
